        ...
        >
          ...
          <Card className="group">
            ...
            <CardDescription className="flex flex-col gap-2">
              <span className="text-3xl font-semibold group-hover:text-primary text-foreground">
                ${item.price}
              </span>
              <span className="">{item.description}</span>
              <div className="text-primary-foreground bg-primary px-10 py-2 rounded-md text-center hover:bg-primary/90 transition-colors">
                Buy Now
              </div>
            </CardDescription>
          </Card>
